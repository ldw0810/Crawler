    ...
    Bjuiajax.prototype.TOOLS = function() {
        ...
        var tools = {
            getPagerForm: function($parent, args) {
                var formFirst = $parent.find('#pagerForm:first')[0]
                if (!formFirst || formFirst.length == 0) {
                    formFirst = $parent.find('.pagerForm:first')[0]
                }
                var form     = $parent.isTag('form') ? $parent[0] : formFirst
